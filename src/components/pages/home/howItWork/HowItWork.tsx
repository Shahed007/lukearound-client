...
export default function HowItWorks() {
  ...
  const cardVariants: Variants = {
    ...
    visible: { opacity: 1, y: 0, rotate: 0, transition: { type: "spring" as const, stiffness: 100, damping: 12, duration: 0.9 } },
  };

  const iconVariants: Variants = {
    hidden: { scale: 0, rotate: -180 },
    visible: { scale: 1, rotate: 0, transition: { type: "spring" as const, stiffness: 200, damping: 12, duration: 1 } },
  };
  ...
  const glowEffect: Variants = {
    ...
    visible: {
      ...
      transition: { duration: 1.5, times: [0, 0.5, 0.8, 1], repeat: Infinity, repeatDelay: 2 },
    },
  };
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 mt-6 mb-3">
      ...
      >
        <motion.h2 className="text-5xl font-bold text-gray-900 mb-6" variants={titleVariants}>
          How It Works
        </motion.h2>
        <motion.div variants={titleVariants}>
          <motion.p className="text-gray-600 max-w-2xl mx-auto text-xl" variants={glowEffect}>
      ...
      >
        ...
        >
          ...
          <div className="mb-6">
            ...
            >
              <Image src={ico1} alt="Discovery & Analysis Icon" className="w-10 h-10" />
            </motion.div>
          </div>
          <motion.h3 className="text-2xl font-bold text-gray-900 mb-4 text-center" variants={titleVariants}>
            Discovery & Analysis
          </motion.h3>
          <motion.p className="text-gray-600 text-center mb-6 leading-relaxed text-lg" variants={listItemVariants}>
            Deep dive into company culture, role requirements, and candidate aspirations
          </motion.p>
          <motion.ul className="space-y-4" variants={containerVariants}>
            {["Comprehensive needs assessment", "Cultural fit evaluation", "Skills gap analysis", "Market research"].map((text, idx) => (
              <motion.li key={idx} className="flex items-start" variants={listItemVariants} whileHover={{ x: 5 }}>
        ...
        >
          ...
          <div className="mb-6">
            <motion.div
              ...
              whileHover={{ scale: 1.1, rotate: 5, transition: { duration: 0.3 } }}
            >
              <Image src={ico2} alt="Talent Sourcing Icon" className="w-10 h-10" />
            </motion.div>
          </div>
          <motion.h3 className="text-2xl font-bold mb-4 text-center" variants={titleVariants}>
            Talent Sourcing
          </motion.h3>
          <motion.p className="text-slate-300 text-center mb-6 leading-relaxed text-lg" variants={listItemVariants}>
            Leverage our extensive network and advanced tools to identify top candidates
          </motion.p>
          <motion.ul className="space-y-4" variants={containerVariants}>
            {["Global talent network access", "AI-powered candidate matching", "Passive candidate engagement", "Diversity-focused sourcing"].map((text, idx) => (
              <motion.li key={idx} className="flex items-start" variants={listItemVariants} whileHover={{ x: 5 }}>
        ...
        >
          ...
          <div className="mb-6">
            <motion.div
              ...
              whileHover={{ scale: 1.1, rotate: 5, transition: { duration: 0.3 } }}
            >
              <Image src={ico3} alt="Vetting & Placement Icon" className="w-10 h-10" />
            </motion.div>
          </div>
          <motion.h3 className="text-2xl font-bold text-gray-900 mb-4 text-center" variants={titleVariants}>
            Vetting & Placement
          ...
          <motion.ul className="space-y-4" variants={containerVariants}>
            {["Multi-stage interviews", "Technical assessments", "Reference verification", "Onboarding assistance"].map((text, idx) => (
              <motion.li key={idx} className="flex items-start" variants={listItemVariants} whileHover={{ x: 5 }}>
